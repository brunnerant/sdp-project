...
public class EditQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Intent intent = getIntent(); questionBuilder = (Question.Builder)
         * Objects.requireNonNull(intent.getExtras()) .getSerializable(QUESTION_BUILDER); StringPool
         ...
         * questionBuilder.setFormat(MatrixFormat.singleField(MatrixFormat.Field.textField("",
         * 25)));
         *
         * <p>intent = new Intent(); intent.putExtra(QUESTION, questionBuilder.build());
