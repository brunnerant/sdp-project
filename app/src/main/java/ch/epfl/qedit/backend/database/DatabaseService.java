...
public interface DatabaseService {
    ...
    /**
     * Upload a Quiz to the database with a string-pool attached to it.
     *
     * @param quiz to upload
     * @param stringPool attached to the quiz to upload
     * @return a future with the new quiz id generated by the database
     */
