...
/**
 * This interface is used to request location updates from the phone. It is an interface,
 * so that it can be mocked for the tests.
 */
public interface LocationService {
    /**
     * Subscribes to the location service using the given location listener. The location
     * updates should be done at the given interval (in milliseconds), if possible.
